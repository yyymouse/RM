...
#define M3505_v_D 1.0f
#define M3508_out_max  16000.0f
#define M3508_iout_max 2000.0f
 
#define M3505_angle_P  10.0f  //10.0f   //底盘角度环   8
#define M3505_angle_I  0.0f
#define M3505_angle_D  30.0f  //30.0f
#define M3508_angle_out_max  20.50f
#define M3508_angle_iout_max 10.2f

#define M3505_speed_P 6.0f    //底盘速度环   3
#define M3505_speed_I 0.0f
#define M3505_speed_D 1.7f
...
//#define TOP_SPIN_SPEED 6.0f //小陀螺转速    9

//旧小黑x 330       y 390
//新小黑x 400       y 375

#define MOTOR_DISTANCE_TO_CENTER 0.400421549f  //底盘旋转速度倍率   （x/2+y/2）*0.001
...
typedef enum
{
  chassis_mode_spin,           //小陀螺模式
	chassis_mode_fan_spin,      //反向小陀螺
  chassic_follow_chassic_yaw,  //底盘跟随云台     
  chassic_zero,                //底盘停止模式
	division_mode,               //一点掉头模式
  chassis_mode_spin2//二级小陀螺
} chassis_mode_e;
