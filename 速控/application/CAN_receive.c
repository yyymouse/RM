    ...
    switch (rx_header_1.StdId)                                   //接收can1的数据存入
    {
        ...
        case CAN_TRIGGER_MOTOR_ID:
								...
								case CAN_SUPER_CAP_RE_ID:
				{
					...
					super_cap_measure.InputVot = (float)pPowerdata[1] / 100.0f;//????
					super_cap_measure.CapVot = (float)pPowerdata[0] / 1000.0f;//????
					super_cap_measure.Test_current = (float)pPowerdata[2] ;//???
					super_cap_measure.Target_Power = (float)pPowerdata[3] / 100.0f;//????
					break;
				}
...
/**
  ...
  * @retval         none
  */
void CAN_cmd_chassis(int16_t motor_left, int16_t motor2, int16_t motor3, int16_t motor4)
{
    uint32_t send_mail_box;
...
/**
  ...
  * @retval         none
  */
void CAN_cmd_shoot(int16_t motor_left, int16_t motor2, int16_t motor3, int16_t motor4)
{
    uint32_t send_mail_box;
    ...
    gimbal_shoot_can_send_data[0] = motor_left >> 8;
    gimbal_shoot_can_send_data[1] = motor_left;
