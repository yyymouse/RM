...
//角速度计低通滤波
static fp32 gyro_fliter_1[3] = {0.0f, 0.0f, 0.0f};
static fp32 gyro_fliter_2[3] = {0.0f, 0.0f, 0.0f};
static fp32 gyro_fliter_3[3] = {0.0f, 0.0f, 0.0f};

static const fp32 fliter_num[3] = {1.929454039488895f, -0.93178349823448126f, 0.002329458745586203f};


 fp32 INS_gyro[3] = {0.0f, 0.0f, 0.0f};//陀螺仪角速度数据
 fp32 INS_accel[3] = {0.0f, 0.0f, 0.0f};//陀螺仪加速度数据
...
void INS_task(void const *pvParameters)
{
    ...
    accel_fliter_1[2] = accel_fliter_2[2] = accel_fliter_3[2] = INS_accel[2];
		...
		gyro_fliter_1[0] = gyro_fliter_2[0] = gyro_fliter_3[0] = INS_gyro[0];
    gyro_fliter_1[1] = gyro_fliter_2[1] = gyro_fliter_3[1] = INS_gyro[1];
    gyro_fliter_1[2] = gyro_fliter_2[2] = gyro_fliter_3[2] = INS_gyro[2];
    ...
    while (1)
    {
        ...
        //角速度计低通滤波
        //accel low-pass filter
        gyro_fliter_1[0] = gyro_fliter_2[0];
        gyro_fliter_2[0] = gyro_fliter_3[0];

        gyro_fliter_3[0] = gyro_fliter_2[0] * fliter_num[0] + gyro_fliter_1[0] * fliter_num[1] + INS_gyro[0] * fliter_num[2];

        gyro_fliter_1[1] = gyro_fliter_2[1];
        gyro_fliter_2[1] = gyro_fliter_3[1];

        gyro_fliter_3[1] = gyro_fliter_2[1] * fliter_num[0] + gyro_fliter_1[1] * fliter_num[1] + INS_gyro[1] * fliter_num[2];

        gyro_fliter_1[2] = gyro_fliter_2[2];
        gyro_fliter_2[2] = gyro_fliter_3[2];

        gyro_fliter_3[2] = gyro_fliter_2[2] * fliter_num[0] + gyro_fliter_1[2] * fliter_num[1] + INS_gyro[2] * fliter_num[2];

        
				AHRS_update(INS_quat, timing_time, INS_gyro, accel_fliter_3, INS_mag);

//        AHRS_update(INS_quat, timing_time, gyro_fliter_3, accel_fliter_3, INS_mag);
