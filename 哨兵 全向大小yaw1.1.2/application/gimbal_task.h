...
#define MAX_ANGLE 0.6f   //pi/180*角度
#define MIN_ANGLE -0.96f

//pitch gyro angle close-loop PID params, max out and max iout
//pitch 角度环 角度由陀螺仪解算 PID参数以及 PID最大输出，积分输出
#define PITCH_GYRO_ABSOLUTE_PID_KP  50.0f //26   //150    50
#define PITCH_GYRO_ABSOLUTE_PID_KI  4.0f
#define PITCH_GYRO_ABSOLUTE_PID_KD  0.2f
...
#define PITCH_SPEED_PID_KP        5500.0f    // 3000
#define PITCH_SPEED_PID_KI        0.01f//60.0f
...
#define YAW_GYRO_ABSOLUTE_PID_KP        20.0f//35.0f //20.0f  //130   不开陀螺的自瞄       有预测
#define YAW_GYRO_ABSOLUTE_PID_KI        0.01f//0.0f
#define YAW_GYRO_ABSOLUTE_PID_KD        4.0f//0.0
#define YAW_GYRO_ABSOLUTE_PID_MAX_OUT   15.0f
#define YAW_GYRO_ABSOLUTE_PID_MAX_IOUT  0.0f

#define YAW_SPEED_PID_KP        5500.0f//2900.0f //3600
#define YAW_SPEED_PID_KI        0.01f//20.0f
...
#define RC_DEADBAND   10 //原来的值10，yao

#define gimbal_pitch_CHANNEL  3
//pitch和yaw的遥控器通道号码
#define gimbal_yaw_CHANNEL    2

#define Motor_Angle_to_Rad_YAW    -0.00005f//自瞄跟随速度  -0.0001f
#define Motor_Angle_to_Rad_PITCH  -0.00005f//自瞄跟随速度  -0.0001f
...
#define yaw_ecd         2727    //yaw轴电机头正方向电机值   小绿2880    小黑150    4250   //小黑2号6000    全向轮3915
#define yaw_back_ecd    150

#define pitch_offset_ecd  6780      //pitch轴电机水平方向电机值   小绿2800    小黑6780

#define YAW_MOUSE_SEN   0.0005f//0.00005f
#define PITCH_MOUSE_SEN 0.0005f//f0.00015f
